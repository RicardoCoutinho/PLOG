...
msg_init :-
    ...
    write('         ei12161 - Jos� Ricardo Coutinho'), nl,
    nl,
...
msg_regras :- nl,nl,nl,
    write(' REGRAS: '),nl,nl,
    write(' - O objectivo do jogo � obter mais pontos que o outro jogador.'),nl,
    write(' - A pontua��o de cada jogador � contabilizada no final e � igual'),nl,
    write('   � soma do valores das quadriculas em que as pe�as desse jogador'),nl,
    write('   se encontram.'),nl,
    write(' - As pe�as s� podem ser colocadas na vertical ou horizontal.'), nl,
    write(' - As pe�as podem empurrar na dire��o dos seus extremos.'),nl,nl,
    write(' As restantes regras s�o aprendidas jogando. Boa sorte!'),nl,nl,nl,nl,
